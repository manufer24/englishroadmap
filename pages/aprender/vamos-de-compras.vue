<template>
    <MainLayout>
        <section class="container mx-auto min-h-auto min-h-[192px]">
            ...
            border-b border-natural-content">Aprende a comprar en inglés</h1>
            <article class="py-8 px-0">
                <div class="border-b border-natural-content pb-6 sm:pl-4">
                    <p>
                        Aquí encontrarás una serie de enlaces con material audio visual para que aprendas a comprar de forma correcta en inglés
                ...
                <ul class="py-8 px-0">
                    <li class="mb-2 before:content-['1'] before:text-primary">
                        <nuxt-link 
                            ...
                            to="https://www.anglomaniacy.pl/expressions-17-shopping-lesson.htm"
                        ...
                        <ul>
                            <li class="pl-10 py-2 before:content-['1.1'] before:text-secondary">
                                <nuxt-link
                                    ...
                                    to="https://www.anglomaniacy.pl/expressions-17-shopping-printables.htm"
                                    target="_blank" rel="noopener noreferrer"
                                    >
                            ...
                            <li class="pl-10 py-2 before:content-['1.2'] before:text-secondary">
                                <nuxt-link
                                    class="underline px-2 sm:hover:text-secondary sm:transition:colors duration-200" 
                                    to="https://www.anglomaniacy.pl/expressions-17-shopping-comics.htm"
                                    target="_blank" rel="noopener noreferrer"
                                    >
                                    historietas
                                </nuxt-link>
